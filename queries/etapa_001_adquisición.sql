...
INSERT INTO DQM_check_catalog(check_code, description) VALUES
...
CREATE TABLE IF NOT EXISTS DQM_cast_issues(
  ...
  check_code TEXT, invalid_count BIGINT,
  sample_value TEXT, created_at TIMESTAMP DEFAULT now()
);

CREATE TABLE IF NOT EXISTS DQM_pk_issues(
  issue_id BIGSERIAL PRIMARY KEY,
  table_name TEXT, check_code TEXT,
  duplicates_count BIGINT, created_at TIMESTAMP DEFAULT now()
);

CREATE TABLE IF NOT EXISTS DQM_fk_issues(
  issue_id BIGSERIAL PRIMARY KEY,
  table_name TEXT, fk_name TEXT,
  check_code TEXT, orphan_count BIGINT,
...
CREATE TABLE IF NOT EXISTS DQM_field_profile(
  profile_id BIGSERIAL PRIMARY KEY,
  table_name TEXT, column_name TEXT,
  null_count BIGINT, distinct_count BIGINT,
  min_val TEXT, max_val TEXT, example_value TEXT,
  created_at TIMESTAMP DEFAULT now()
);
